  ...
  <div class="col-md-8">
    ...
    <div>
      <div class="card flex-md-row mb-2">
        @if(file_exists("storage/user_image/user_{$room['creator_id']}.jpg"))
        <img class="rounded-circle" src="/storage/user_image/user_{{$room['creator_id']}}.jpg" alt="プロフィール画像"
        ...
        <div class="bg-warning">
          @elseif(in_array($room['room_id'], $joined_room))
          <div class="bg-info">
            @endif
            <div class=" card-body align-items-start">
              <a href="/category/detail?category_id={{$room['category_id']}}" class="mb-2 text-primary font-weight-bold"
              ...
              <span
                class="mb-1 text-muted">{{ $room['created_date']=date('Y年m月d日　H時i分s秒', strtotime($room['created_date'])) }}</span>
              <h4 class="mb-0">
